   ...
   ============================================================*/
{
	...
	if (propertylist.GetLength())
	{
		...
		r.top += height;
		textRect = r;
		textRect.bottom = textRect.top + (LONG)m_properties.GetSize() * height;
		dc->DrawText(propertylist, textRect, DT_NOPREFIX | DT_WORDBREAK | DT_CENTER);
		lines += (int)m_properties.GetSize();
		r.top += height * (LONG)m_properties.GetSize();
	}
   ...
   ============================================================*/
{
	...
	INT_PTR attributes = GetAttributes();
...
INT_PTR	CUMLEntityClass::GetAttributes() const
/* ============================================================
...
INT_PTR CUMLEntityClass::GetOperations() const
/* ============================================================
...
CAttribute* CUMLEntityClass::GetAttribute(INT_PTR index) const
/* ============================================================
...
COperation* CUMLEntityClass::GetOperation(INT_PTR index) const
/* ============================================================
   ...
   ============================================================*/
{
	...
	INT_PTR max = m_baseClassArray.GetSize();
	for (INT_PTR t = 0; t < max; t++)
	{
