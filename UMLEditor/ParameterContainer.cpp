   ...
   ============================================================*/
{
	...
	RemoveAll();
	INT_PTR max = parameters.GetSize();
...
// Implementation
INT_PTR CParameterContainer::GetSize() const
/* ============================================================
...
CParameter* CParameterContainer::GetAt(INT_PTR index) const
/* ============================================================
...
void CParameterContainer::RemoveAt(INT_PTR index)
/* ============================================================
